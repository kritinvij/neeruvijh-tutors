  ...
  return (
    ...
    >
      ...
      <div className="absolute top-0 left-0 right-0" aria-hidden="true">
        <svg
          viewBox="0 0 1440 80"
          className="w-full fill-amber-50"
      ...
      <div className="absolute top-[-25%] left-[-15%] w-[55%] h-[65%] rounded-full bg-amber-300/20 blur-[90px] nv-float-1 pointer-events-none" />
      <div className="absolute bottom-[-20%] right-[-12%] w-[50%] h-[60%] rounded-full bg-orange-700/15 blur-[80px] nv-float-2 pointer-events-none" />
      <div className="absolute top-[30%] right-[20%] w-[30%] h-[40%] rounded-full bg-white/[0.07] blur-[60px] nv-float-3 pointer-events-none" />
      ...
      <div className="relative max-w-4xl mx-auto px-6 text-center">
        ...
        <AnimateIn delay={0.15}>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-2xl mx-auto">
            ...
            >
              <div className="w-10 h-10 bg-green-500 rounded-full flex items-center justify-center mb-3 mx-auto">
